...
export function FireMap({ interactive = true, onMapClick, className = '' }: FireMapProps) {
  ...
  }, [center, interactive, setCenter, setZoom, zoom])
  ...
  useEffect(() => {
    ...
    fireReports.forEach((report: FireReport) => {
      ...
      const detectedAt = report.detected_at
  ...
  }, [mapLoaded, measure.getLineGeoJSON, measure.getPointsGeoJSON])
