...
import { useCreateResource, useResources, useUpdateResource } from '@/hooks/use-resources'
...
export default function RecursosPage() {
  ...
  const handleCreate = async () => {
    ...
    if (newResourceType === 'volunteer') {
      ...
      capacity = cap ? parseInt(cap, 10) : undefined
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Administra vehículos, personas y equipamiento</p>
        </div>
                  ...
                  <>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setVehicleData({ ...vehicleData, patente: e.target.value })
                        }
                        placeholder="ABC 123"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setVehicleData({ ...vehicleData, propietario: e.target.value })
                          }
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setVolunteerData({ ...volunteerData, dni: e.target.value })
                          }
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setVolunteerData({ ...volunteerData, telefono: e.target.value })
                          }
                  ...
                  <>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setEquipmentData({ ...equipmentData, nombre: e.target.value })
                        }
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {TYPE_OPTIONS.map((type) => {
          ...
          const available = resources.filter(
            (r) => r.type === type.value && r.status === 'available',
          ).length
          return (
            <Card key={type.value}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">{available} disponibles</p>
              </CardContent>
            </Card>
          )
        })}
        ...
        <>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Camiones cisterna y vehículos de apoyo</CardDescription>
            </CardHeader>
            <CardContent>
              {vehiculos.length === 0 ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Voluntarios y personal de apoyo</CardDescription>
            </CardHeader>
            <CardContent>
              {personas.length === 0 ? (
                <div className="text-center py-6 text-muted-foreground">
                  ...
                  <TableBody>
                    {personas.map((resource) => {
                      ...
                      return (
                        <TableRow key={resource.id}>
                          <TableCell className="font-medium">
                            {meta?.nombre_completo || resource.name}
                          </TableCell>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Herramientas y equipos de emergencia</CardDescription>
            </CardHeader>
            <CardContent>
